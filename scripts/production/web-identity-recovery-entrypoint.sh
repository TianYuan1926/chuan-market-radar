...
unset WEB_READY_TIMEOUT_SECONDS WEB_READY_POLL_SECONDS FULL_HEALTH_TIMEOUT_SECONDS FULL_HEALTH_POLL_SECONDS
unset WEB_IDENTITY_RECOVERY_FORCE_CONTAINER_VALIDATOR
...
FULL_HEALTH_TIMEOUT_SECONDS=1200 \
FULL_HEALTH_POLL_SECONDS=10 \
