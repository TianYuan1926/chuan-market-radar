...
function lineage() {
  return {
    ...
    activationEvidenceSha256: "1".repeat(64),
    activationSamplesSha256: "2".repeat(64),
    accumulationEvidenceSha256: "3".repeat(64),
    accumulationSamplesSha256: "4".repeat(64),
    freshEvidenceSha256: "5".repeat(64),
    freshSamplesSha256: "6".repeat(64),
    ...
    currentReleaseId: "candidate-shadow-fresh-cycle-two",
    currentAuthorityEpoch: 1,
    freshCycleStartedAt: "2026-07-18T00:00:00.000Z",
    sourceReleaseWindows: [
      {
        migrationId: "candidate-episode-v1",
        releaseId: "candidate-shadow-activation-cycle-one",
        authorityEpoch: 3,
      ...
      },
      {
        ...
        releaseId: "candidate-shadow-fresh-cycle-two",
        authorityEpoch: 1,
...
function reconciliation() {
  return {
    ...
    databaseIdentity: { currentRole: "candidate_audit_role", transactionReadOnly: true },
    observationIdentityBinding: "embedded_request_database_exact_match",
