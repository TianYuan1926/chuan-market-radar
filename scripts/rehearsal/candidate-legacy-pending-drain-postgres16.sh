...
WORK_DIR="$(mktemp -d /tmp/market-radar-candidate-legacy-pending-drain-pg16.XXXXXX)"
DATA_DIR="${WORK_DIR}/data"
SOCKET_DIR="$(mktemp -d /tmp/wp_g0_2_rehearsal_candidate_legacy_pending_drain_socket.XXXXXX)"
PORT="$((58232 + RANDOM % 300))"
DATABASE="wp_g0_2_rehearsal_candidate_legacy_pending_drain"
