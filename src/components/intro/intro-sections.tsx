...
const STEPS = [
  ...
  },
  {
    ...
    k: '05',
    title: '复盘沉淀进化',
    desc: '用信号生命周期、最大浮盈/最大回撤、漏判复查和策略分型统计积累可复盘样本。',
  },
]
      ...
      <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6">
        <Reveal className="mb-12 text-center">
          ...
          <h2 className="mt-4 text-balance text-3xl font-bold tracking-tight sm:text-4xl">
            从一条市场数据，到<span className="text-neon">一次证据确认</span>
          </h2>
          <p className="mx-auto mt-3 max-w-xl text-pretty text-muted-foreground">
            五个环节闭环运转，把候选、证据和计划状态分清楚
          </p>
        </Reveal>
...
const FEATURES = [
  {
    icon: Crosshair,
    title: '异动狙击',
    desc: '锁定突发放量与资金异动，先标记候选和证据成熟度，再等待后端计划确认。',
  },
  {
    icon: Waves,
    title: '资金流向追踪',
    desc: '可视化可接入的成交、持仓、资金费率与强弱数据，看清价格背后的资金质量。',
  },
  {
    icon: Gauge,
    title: '分层扫描节奏',
  ...
  },
  {
    icon: ShieldCheck,
    title: '风险等级提示',
    desc: '每条信号附带风险评级、反证和失效边界，帮助你控制回撤而非盲目追涨。',
  },
  {
    icon: Eye,
    title: '覆盖证明',
...
const PERSONAS = [
  ...
  },
  {
    ...
    icon: Waves,
    pain: '看不清主力在悄悄做什么',
    gain: '成交、持仓、资金费率和相对强弱追踪，筛出更值得复查的趋势候选。',
  },
  {
    tag: '风控守门人',
    icon: ShieldCheck,
...
const FAQS = [
  {
    q: '川的异动信号是如何产生的？',
    a: '川聚合交易所公开行情、CoinGlass 衍生品和本地扫描状态，通过成交量、持仓、资金费率、相对强弱等证据交叉验证，分层生成候选、证据信号和计划状态。',
  },
  {
    q: '信号延迟有多低？',
  ...
  {
    q: '我需要懂技术分析才能使用吗？',
    a: '不需要。每条信号都会标注方向、异动强度、风险等级和计划状态；完整交易计划只在后端证据满足时展示。',
  },
  {
    q: '川会替我自动交易吗？',
