        ...
        statePool: {
          assetSamples: [
            ...
            },
            {
              ...
              cadenceHint: "高频复扫",
              nextAction: "进入深扫候选",
              priorityReason: "price_volume_anomaly",
            ...
            },
            {
              ...
              cadenceHint: "低频探索",
              nextAction: "等待复活观察",
              priorityReason: "long_tail_exploration",
          ...
          deepScan: {
            ...
            battleSlots: 2,
            capacity: 6,
            deepScanCoveragePercent: 1.43,
            estimatedCycleMinutes: 1050,
            explorationSlots: 1,
            guardrail: "保留冷门探索槽位",
            ...
            pendingQualitySamples: [
              {
                baseAsset: "SUI",
                priorityReason: "dynamic_priority:queued",
                state: "WARM",
                symbol: "SUIUSDT",
              },
              {
