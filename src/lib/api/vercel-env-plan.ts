...
const envDefinitions: EnvDefinition[] = [
  ...
  },
  {
    ...
    description: "CoinGlass 基础优先池，不是全市场上限；真实币池还会合并公开 USDT 永续 universe。",
  ...
  {
    defaultValue: "24",
    description: "每个 15m 主扫描窗口的 CoinGlass pairs-markets 请求数；Hobbyist 30/min 阶段默认保留余量。",
  ...
  {
    defaultValue: "3000",
    description: "CoinGlass 主扫描每日请求预算；24/15m 约 2304 次/日，3000 留出失败重试和手动刷新余量。",
  ...
  {
    defaultValue: "6",
    description: "CoinGlass 主扫描受控并发数，避免 24 个币串行拖慢 Vercel 函数，同时低于 30/min 限速。",
    key: "COINGLASS_MAX_CONCURRENCY",
    requiredFor: ["production"],
    sensitivity: "server",
  },
];
