...
export type M0ExitReport = Readonly<{
  ...
  nextEntry: "LOCAL_NEXT=V2-M2.2-B0.2-C-FIRST-PARTY-FORWARD-INSTRUMENT-CAPTURE EXTERNAL_GATE=V2-M2.2-B0.2-B-EXACT-SOURCE-RIGHTS-AND-CAPABILITY-RESOLUTION DETECTORS_DRAFT";
}>;
