...
const fixtures: RuntimeArtifactByName = {
  ...
  OutcomeRecord: {
    ...
    generatedAt: "2026-01-15T00:16:01.000Z",
    sourceCutoff: EXPIRES_AT,
    ...
    strategyContextTags,
    strategyStateLabel,
    outcomePolicyVersion: "outcome-policy-fixture.v1",
    measurementFactIds: ["outcome-fact-fixture-1"],
    eventStatus: "OBSERVED",
    opportunityEventId: "opportunity-event-fixture-1",
    eventLabelVersion: "significant-expansion-event.v1",
    eventStartAt: "2026-01-15T00:10:00.000Z",
    firstDetectedAt: SOURCE_CUTOFF,
    checkpoint: "4H",
    status: "TP_FIRST",
