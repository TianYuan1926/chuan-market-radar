...
腾讯隔离 live B0、真实四 Venue/地区/Hobbyist 可用性、M1.4A、四 Venue Shadow、扩展容量、分域校准和生产 authority 均未证明。

### 下一轮建议

先绑定 exact clean commit 执行腾讯隔离 `LIVE_READ_ONLY` B0；只让实际 PASS 的 capability 进入 M1.4A。生产 P0R 继续独立推进。
