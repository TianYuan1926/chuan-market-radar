...
CHUAN_TRUSTED_PRIVATE_NETWORK=false
CHUAN_HSTS_MAX_AGE=0
...
WS_LIGHT_SCAN_BOOK_STREAMS_ENABLED=true
WS_LIGHT_SCAN_LARGE_TAKER_TRADE_USD=100000
...
echo "  WS_LIGHT_SCAN_BOOK_STREAMS_ENABLED=true"
echo "  WS_LIGHT_SCAN_LARGE_TAKER_TRADE_USD=100000"
