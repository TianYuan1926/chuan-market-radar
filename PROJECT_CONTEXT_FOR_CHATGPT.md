...
- `docs/blueprints/MARKET_RADAR_V2_CONTROLLED_REPLACEMENT_BLUEPRINT_V1.md`，内容版本 v1.44。
- `docs/blueprints/market-radar-v2-controlled-replacement-traceability.v1.json`，机器合同 v1.49。
...
A0_ENGINEERING_MATERIALS_AND_SUPPLY_CHAIN_LOCAL_PASS / A0_TOTAL_GATE_INCOMPLETE / M1.5C_M1.5D_BLOCKED_BY_A0
...
A0：精确版本、零高危依赖、许可证、SBOM、固定 CI/Action/runner/base-image、双重 lint、Next build、原生材料烟测与 exact Node 22.23.1/npm 10.9.8 本地完整 CI 已 PASS；GitHub 远端 exact-runtime、独立 secret/SAST/镜像扫描、性能/资源基线、制品 provenance/回滚和 P0R 真实恢复未齐，因此总门禁未完成，M1.5C/M1.5D 尚不允许启动
