...
- exact commit `3908f9f5d0066849311e9d3ac875cc6a76acc69e` 的进程观察到 31 周期，但 Runner/validator reconciliation 参数漂移导致完整证据未保住，结论固定为 `EXECUTION_INVALID_NOT_COUNTED`。
