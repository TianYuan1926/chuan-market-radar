...
Current package: V2-M1.3 Fact Store, Replay Manifest and Runtime Truth Rehearsal
Current package status: LOCAL_POSTGRES16_REHEARSAL_PASS / LIVE_INGESTION_UNPROVEN / PRODUCTION_UNCHANGED
Next package: V2-M1.4 Full Eligible Universe and Collector Runtime
```
