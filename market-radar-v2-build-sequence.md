...
- [ ] **M2.3A Listing/Venue Event Detection**：R0 已完成 point-in-time 事件研究真值纵切：四 Venue、十四类事件、M1 lifecycle ledger v2 publication/effective/knowledge 三时间、exact event denominator、identity epoch、source coverage 和 content hash 均由 strict schema/builder 验证；未关联公告不猜 symbol，首次目录观察只算 baseline，目录消失不推断 delist，无支持合约新币只 WATCH_ONLY，股票事件 handoff M2.3B，partial identity 显式 BLOCKED。source `1d0a4a79f3673d0439f305d4171c738f6252c998` 定向 `14/14`、相邻 `65/65`、完整 candidate CI 和 GitHub Signed Dispatch `30699019243`、A0 `30699019238`、Independent Security `30699019242`、Full Quality `30699019235` 全部 PASS。当前仍为 `R0_LOCAL_EVENT_TRUTH_VERTICAL_PASS / NO_CANDIDATE_DIRECTION_PROBABILITY_SIGNAL_STRATEGY_READY_OR_PRODUCTION_AUTHORITY`；真实 source coverage、M1.5C/M1.5D、M1.6-D1、M2.4A cohort/matched control/untouched holdout/calibration、Shadow 和独立审计未完成，因此不勾选、不计完整 Detector。
...
Last completed listing event research package: V2-M2.3A-R0-LISTING-VENUE-EVENT-RESEARCH-VERTICAL = LOCAL_EVENT_TRUTH_VERTICAL_PASS_14_OF_14_FULL_CANDIDATE_CI_REMOTE_FOUR_GATES_PASS_NO_CANDIDATE_OR_PRODUCTION_AUTHORITY
