...
Binance spot catalog = /api/v3/exchangeInfo?showPermissionSets=false
```
...
V2 Foundation = 422 pass / 6 explicit skip
V2 Ops = 125/125 PASS
...
```text
source commit = d557c666e2e27b67842354b869a64271c91ceae1
dispatch = m1b0-r2-live-source-20260723t165411z
dispatch commit = 677a7dd53bb740351cdb18f59992c5bdf73118aa
probe counts = 14 pass / 1 fail / 0 not-run
failed probe = BINANCE_SPOT_CATALOG
failure = SCHEMA_DRIFT_UNAVAILABLE
gate status = identity PASS / listing BLOCKED / CoinGlass PASS
productionChanged = false
secretMaterialPresent = false
```
