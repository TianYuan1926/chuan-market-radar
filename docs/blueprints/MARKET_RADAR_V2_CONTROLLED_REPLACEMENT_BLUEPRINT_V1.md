...
- `A0`：`ENGINEERING_MATERIALS_SUPPLY_CHAIN_AND_INDEPENDENT_SECURITY_PASS / TOTAL_GATE_INCOMPLETE / PRODUCTION_UNCHANGED`。精确版本、零高危依赖、许可证、SBOM、Actions/runner/Docker pin、双重 lint、Next 构建、原生材料烟测、exact-runtime Ubuntu 完整 CI、完整历史 Gitleaks、CodeQL SAST 和 collector 镜像 Trivy 已通过；host tar 方言、浅 Git 历史、Gitleaks 重复误报与 CodeQL suppression 缺失均完成根因治理和防复发门禁。性能/资源基线、完整制品 provenance/回滚以及 P0R 真实恢复仍未形成完整证据。
...
材料、供应链与独立安全子门禁已本地与远程通过并固化为 `v2:a0:materials:verify`、`test:v2-a0-materials`、运行烟测、`v2-full-quality.yml` 和 `v2-security-quality.yml`。host tar 修复提交 `29ab47dec0b9fbbbe66e1cfe7ce90aa2e1e4c25d` 已取得 Signed Dispatch Ubuntu PASS；浅 Git 历史修复提交 `1d5638d0fb538bacec09086ec7b719d9e7a85ce9` 已由 Full Quality `30200077285` 复验 PASS；安全源提交 `4f501b0fb8b917ce87e0687eab8480b5c9595f27` 已由 Security `30209898205` 和 Full Quality `30209898207` 复验 PASS。详细证据见 `docs/blueprints/V2_A0_INDEPENDENT_SECURITY_QUALITY_DELIVERY_REPORT.md`。P0R 的真实离机备份与独立 PostgreSQL 16 恢复仍是独立生产第一关键路径。A0 总 PASS 前只允许继续无 authority 的本地工程，不允许启动 M1.5C/M1.5D 或宣称工程地基完整。
