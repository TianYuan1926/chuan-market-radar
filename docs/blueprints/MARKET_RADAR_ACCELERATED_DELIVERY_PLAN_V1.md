...
| 20 | WP-G0.2 canonical cutover | A | prohibited | reconciliation、dual-read 24h、canonical-compat 24h、生产 Reader/API/前端合同 PASS + 独立审批 |
| 21 | WP-G0.3/G0.4/G0.5 | A/B | queued | WP-G0.2 完成并按独立包执行 |
