...
只有 `LIVE_READ_ONLY` 的 identity、listing 和 CoinGlass Gate 实际 PASS，相关 capability 才能进入 M1.4A。失败项保持 unavailable，不允许 stale、mock、其他语义来源或旧 V1 PASS 补位。
