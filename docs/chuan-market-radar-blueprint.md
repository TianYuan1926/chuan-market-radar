...
- 只有位置仍好、止损仍近、目标空间仍远、结构 RR 仍不低于 `3:1`，才允许继续推进交易计划。
...
- 轻扫质量诊断合同：`lightScanQuality.v1` 已展示数据新鲜度、覆盖、候选、rolling-window、volume z-score、worker 心跳和交易边界。
