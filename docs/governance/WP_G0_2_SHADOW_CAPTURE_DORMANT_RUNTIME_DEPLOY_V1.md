...
当前 artifact 固定为 14 个文件，必须包含 `src/lib/candidate-episode/transaction-adapter.ts`，SHA-256 为 `a82ed943e7eae1df94bacb0f0c11439586e14fc3127564556215162bb8d82a50`。此前 artifact checksum `e56d37ff17a34b60e65bdfdb86865691e9b91cdb160b5afaa7940a027deb2b0a`、`78f1e3fa045615fd46dc38739adce0ed14a267e3665a3a1c99501f0520478449`、13 文件 checksum 与更早的 14 文件 checksum 都只保留为历史证据，已经失效，不得再用于任何生产审批。
